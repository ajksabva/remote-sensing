...
def main():
    ...
    if args.resume_from == None and args.load_from == None:
        model.init_weights()
    else:
        p = args.resume_from if args.resume_from is not None else args.load_from
        checkpoint = load_checkpoint(model, p, map_location='cpu')
